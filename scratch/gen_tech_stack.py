...
tech_stack_svg = '''<svg fill="none" viewBox="0 0 1200 1040" width="1200" height="1040" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <style>
      ...
      .icon-disc { fill: url(#icon-bg); stroke: #8B5CF6; stroke-opacity: 0.45; stroke-width: 1.5; }
    </style>
  </defs>
  ...
  <g transform="translate(60 120)">
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <circle class="icon-disc" cx="35" cy="35" r="22"/>
        <g transform="translate(19.5 19.5) scale(0.95)">
...
print("assets/tech-stack.svg updated with enlarged icons!")

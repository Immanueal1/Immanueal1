...
tech_stack_svg = '''<svg fill="none" viewBox="0 0 1200 1040" width="1200" height="1040" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <radialGradient id="icon-glow" cx="50%" cy="50%" r="50%">
      ...
      <stop offset="100%" stop-color="#171A30" stop-opacity="0"/>
    </radialGradient>
  ...
  <g transform="translate(60 120)">
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <circle cx="35" cy="35" r="24" fill="url(#icon-glow)"/>
        <g transform="translate(15.5 15.5) scale(1.2)">
  ...
  <g transform="translate(60 695)">
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        <rect class="card" width="150" height="70" rx="14"/>
        <circle cx="35" cy="35" r="24" fill="url(#icon-glow)"/>
        <g transform="translate(17.5 17.5) scale(1.1)">
...
print("assets/tech-stack.svg updated with borderless & enlarged icons!")

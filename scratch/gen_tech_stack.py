...
tech_stack_svg = '''<svg fill="none" viewBox="0 0 1200 1040" width="1200" height="1040" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <linearGradient id="icon-bg" x1="0" y1="0" x2="100%" y2="100%">
      <stop stop-color="#121426"/>
      <stop offset="100%" stop-color="#1D223A"/>
    </linearGradient>
    ...
    <style>
      ...
      .name { font: 700 13px "Fira Code", ui-monospace, monospace; fill: #F8FAFC; }
      
      .card { fill: url(#card-bg); stroke: #8B5CF6; stroke-opacity: 0.35; stroke-width: 1.5; }
      .icon-disc { fill: url(#icon-bg); stroke: #8B5CF6; stroke-opacity: 0.4; stroke-width: 1.2; }
    </style>
  </defs>
  ...
  <g transform="translate(60 120)">
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 16 2 L 3 9.5 V 24.5 L 16 32 L 29 24.5 V 9.5 Z" fill="#283593" opacity="0.8"/>
        ...
        <text x="82" y="41" text-anchor="middle" class="name">C</text>
      </g>
      ...
      <g transform="translate(142)">
        ...
        <g transform="translate(23 23) scale(0.75)">
          ...
          <rect x="20" y="20" width="8" height="8" rx="2" fill="#8B5CF6" stroke="#22D3EE" stroke-width="1"/>
        </g>
        <text x="82" y="33" text-anchor="middle" class="name">Embedded</text>
        <text x="82" y="50" text-anchor="middle" class="name">C</text>
      </g>
      ...
      <g transform="translate(426)">
        ...
        <text x="82" y="41" text-anchor="middle" class="name">Python</text>
      </g>
      ...
      <g transform="translate(568)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 4 24 Q 10 10, 16 16 T 28 8" stroke="#E16737" stroke-width="2.5" fill="none" stroke-linecap="round"/>
          <path d="M 4 24 Q 12 28, 18 20 T 28 22" stroke="#22D3EE" stroke-width="2" fill="none"/>
          <path d="M 16 16 Q 18 20, 28 22" stroke="#E16737" stroke-width="1.8" fill="none"/>
        </g>
        <text x="82" y="41" text-anchor="middle" class="name">MATLAB</text>
      </g>
      ...
      <g transform="translate(710)">
        ...
        <text x="82" y="41" text-anchor="middle" class="name">Git</text>
      </g>
      ...
      <g transform="translate(852)">
        ...
        <text x="82" y="41" text-anchor="middle" class="name">GitHub</text>
      </g>
    </g>
  </g>
  ...
  <g transform="translate(60 235)">
    ...
    <g transform="translate(0 20)">
      ...
      <g transform="translate(162)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 10 16 C 6 10, 2 12, 2 16 C 2 20, 6 22, 10 16 C 14 10, 18 12, 22 16 C 26 20, 30 18, 30 16 C 30 12, 26 10, 22 16 C 18 22, 14 20, 10 16 Z" stroke="#00979D" stroke-width="3.5" fill="none" stroke-linecap="round"/>
          <path d="M 5 16 H 9 M 21 16 H 27 M 24 13 V 19" stroke="#FFFFFF" stroke-width="1.8" stroke-linecap="round"/>
        </g>
      ...
      <g transform="translate(486)">
        ...
        <g transform="translate(23 23) scale(0.75)">
          ...
          <path d="M 12 16 H 28 L 20 24 H 4 Z" fill="#03234C" stroke="#00A3E0" stroke-width="1"/>
      ...
      <g transform="translate(648)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <rect x="4" y="6" width="24" height="6" rx="2" fill="#22D3EE"/>
          <rect x="4" y="14" width="24" height="6" rx="2" fill="#8B5CF6"/>
          <rect x="4" y="22" width="24" height="6" rx="2" fill="#EC4899"/>
        </g>
  ...
  <!-- ========================================================================= -->
  <!-- CATEGORY 3: PROTOCOLS & HARDWARE BUSSES (CUSTOM VECTOR ICONS) -->
  <!-- ========================================================================= -->
  <g transform="translate(60 350)">
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 2 10 H 8 V 22 H 16 V 10 H 24 V 22 H 30" stroke="#22D3EE" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <path d="M 6 6 L 10 2 L 14 6 M 26 26 L 22 30 L 18 26" stroke="#8B5CF6" stroke-width="2" stroke-linecap="round" fill="none"/>
        </g>
      ...
      <g transform="translate(162)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <line x1="2" y1="8" x2="30" y2="8" stroke="#22D3EE" stroke-width="2"/>
          <line x1="2" y1="14" x2="30" y2="14" stroke="#8B5CF6" stroke-width="2"/>
          <line x1="2" y1="20" x2="30" y2="20" stroke="#EC4899" stroke-width="2"/>
          <line x1="2" y1="26" x2="30" y2="26" stroke="#38BDF8" stroke-width="2"/>
      ...
      <g transform="translate(324)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 2 10 H 12 V 22 H 30" stroke="#22D3EE" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <path d="M 2 22 H 18 V 10 H 30" stroke="#EC4899" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
          <circle cx="12" cy="10" r="2.5" fill="#22D3EE"/>
          <circle cx="18" cy="10" r="2.5" fill="#EC4899"/>
        </g>
      ...
      <g transform="translate(486)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 2 12 Q 8 4, 16 16 T 30 12" stroke="#22D3EE" stroke-width="2.2" fill="none"/>
          <path d="M 2 20 Q 8 28, 16 16 T 30 20" stroke="#8B5CF6" stroke-width="2.2" fill="none"/>
          <line x1="16" y1="4" x2="16" y2="28" stroke="#EC4899" stroke-width="1.5" stroke-dasharray="2 2"/>
        </g>
  ...
  <g transform="translate(60 465)">
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <circle cx="12" cy="16" r="10" fill="#3499CD" opacity="0.8"/>
          <circle cx="20" cy="16" r="10" fill="#F7931E" opacity="0.8"/>
      ...
      <g transform="translate(324)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 18 4 C 18 4, 24 10, 24 16 C 24 22, 19 27, 13 27 C 7 27, 4 22, 4 16 C 4 11, 8 7, 12 5" stroke="#EE4C2C" stroke-width="3" fill="none" stroke-linecap="round"/>
          <circle cx="21" cy="9" r="2.5" fill="#EE4C2C"/>
        </g>
      ...
      <g transform="translate(486)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <circle cx="16" cy="9" r="6" stroke="#FF2A2A" stroke-width="2.5" fill="none"/>
          <circle cx="9" cy="21" r="6" stroke="#00D26A" stroke-width="2.5" fill="none"/>
          <circle cx="23" cy="21" r="6" stroke="#22D3EE" stroke-width="2.5" fill="none"/>
        </g>
      ...
      <g transform="translate(648)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <rect x="6" y="4" width="4" height="24" rx="2" fill="#150458"/>
          <rect x="14" y="10" width="4" height="18" rx="2" fill="#E70488"/>
          <rect x="22" y="16" width="4" height="12" rx="2" fill="#150458"/>
          <circle cx="8" cy="6" r="1.5" fill="#22D3EE"/>
        </g>
      ...
      <g transform="translate(810)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 4 16 L 16 4 L 28 16 L 16 28 Z" fill="#013243" stroke="#4DABCF" stroke-width="2"/>
          <line x1="4" y1="16" x2="28" y2="16" stroke="#4DABCF" stroke-width="1.5"/>
          <line x1="16" y1="4" x2="16" y2="28" stroke="#4DABCF" stroke-width="1.5"/>
        </g>
      ...
      <g transform="translate(972)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 4 24 Q 10 6, 16 16 T 28 8" stroke="#11557C" stroke-width="3" fill="none"/>
          <path d="M 4 20 Q 12 28, 20 12 T 28 22" stroke="#22D3EE" stroke-width="2" fill="none"/>
        </g>
  ...
  <g transform="translate(60 580)">
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 6 4 V 28 M 6 16 L 22 4 M 6 16 L 22 28" stroke="#336699" stroke-width="4" stroke-linecap="round"/>
          <circle cx="22" cy="16" r="3.5" fill="#FFCC00"/>
        </g>
      ...
      <g transform="translate(162)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <rect x="6" y="6" width="20" height="20" rx="4" fill="#00AEEF" fill-opacity="0.2" stroke="#00AEEF" stroke-width="2"/>
          <path d="M 10 16 H 22 M 16 10 V 22" stroke="#22D3EE" stroke-width="2" stroke-linecap="round"/>
        </g>
      ...
      <g transform="translate(324)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <rect x="4" y="6" width="24" height="20" rx="4" fill="#121426" stroke="#22D3EE" stroke-width="1.8"/>
          <path d="M 6 16 Q 10 8, 14 16 T 22 16" stroke="#22D3EE" stroke-width="2" fill="none"/>
          <line x1="4" y1="16" x2="28" y2="16" stroke="#8B5CF6" stroke-opacity="0.3" stroke-width="1"/>
        </g>
      ...
      <g transform="translate(486)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 2 8 H 8 V 16 H 16 V 8 H 22 V 16 H 30" stroke="#EC4899" stroke-width="2" stroke-linecap="round" fill="none"/>
          <path d="M 2 24 H 12 V 18 H 20 V 24 H 30" stroke="#22D3EE" stroke-width="2" stroke-linecap="round" fill="none"/>
        </g>
      ...
      <g transform="translate(648)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <polygon points="16,2 30,26 2,26" fill="none" stroke="#8B5CF6" stroke-width="2"/>
          <path d="M 16 10 L 12 18 H 20 L 16 26" stroke="#22D3EE" stroke-width="2" stroke-linecap="round" fill="none"/>
        </g>
      ...
      <g transform="translate(810)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <rect x="6" y="8" width="20" height="18" rx="3" stroke="#22D3EE" stroke-width="2" fill="none"/>
          <rect x="12" y="4" width="8" height="4" rx="1" fill="#22D3EE"/>
          <path d="M 12 17 H 20 M 16 13 V 21" stroke="#EC4899" stroke-width="2" stroke-linecap="round"/>
        </g>
      ...
      <g transform="translate(972)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <circle cx="16" cy="16" r="12" stroke="#38BDF8" stroke-width="2" fill="none"/>
          <path d="M 8 16 H 24 M 16 8 V 24" stroke="#8B5CF6" stroke-width="2"/>
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <g transform="translate(20 20)">
          <rect width="30" height="30" rx="6" fill="#001E36" stroke="#31A8FF" stroke-width="1.5"/>
          <text x="15" y="21" text-anchor="middle" font-family="sans-serif" font-weight="900" font-size="14" fill="#31A8FF">Ps</text>
        </g>
      ...
      <g transform="translate(162)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(20 20)">
          <rect width="30" height="30" rx="6" fill="#330000" stroke="#FF9A00" stroke-width="1.5"/>
          <text x="15" y="21" text-anchor="middle" font-family="sans-serif" font-weight="900" font-size="14" fill="#FF9A00">Ai</text>
        </g>
      ...
      <g transform="translate(324)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(20 20)">
          <rect width="30" height="30" rx="6" fill="#00005B" stroke="#9999FF" stroke-width="1.5"/>
          <text x="15" y="21" text-anchor="middle" font-family="sans-serif" font-weight="900" font-size="14" fill="#9999FF">Pr</text>
        </g>
      ...
      <g transform="translate(486)">
        ...
        <g transform="translate(20 20)">
          <rect width="30" height="30" rx="6" fill="#001E36" stroke="#31A8FF" stroke-width="1.5"/>
          <text x="15" y="21" text-anchor="middle" font-family="sans-serif" font-weight="900" font-size="14" fill="#31A8FF">Lr</text>
        </g>
    ...
    <g transform="translate(0 20)">
      ...
      <g>
        ...
        <g transform="translate(23 23) scale(0.75)">
          ...
          <path d="M 23 2 L 10 12 L 4 8 L 1 11 L 6 16 L 23 30 Z" fill="#0066B8" opacity="0.7"/>
        </g>
      ...
      <g transform="translate(162)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <path d="M 10 16 C 6 10, 2 12, 2 16 C 2 20, 6 22, 10 16 C 14 10, 18 12, 22 16 C 26 20, 30 18, 30 16 C 30 12, 26 10, 22 16 C 18 22, 14 20, 10 16 Z" stroke="#00979D" stroke-width="3.5" fill="none"/>
          <path d="M 5 16 H 9 M 21 16 H 27 M 24 13 V 19" stroke="#FFFFFF" stroke-width="1.8"/>
        </g>
      ...
      <g transform="translate(486)">
        ...
        <circle class="icon-disc" cx="35" cy="35" r="20"/>
        <g transform="translate(23 23) scale(0.75)">
          <circle cx="8" cy="16" r="4" fill="#2088FF"/>
          <circle cx="24" cy="8" r="4" fill="#2088FF"/>
          <circle cx="24" cy="24" r="4" fill="#2088FF"/>
          <path d="M 12 14 L 20 10 M 12 18 L 20 22" stroke="#2088FF" stroke-width="2"/>
        </g>
